...
-- https://github.com/awesome-wm-widgets/tree/master/volume-widget
...
local utils = require("awm-widgets.volume-widget.utils")
...
local widget_types = {
    icon_and_text = require("awm-widgets.volume-widget.widgets.icon-and-text-widget"),
    icon = require("awm-widgets.volume-widget.widgets.icon-widget"),
    arc = require("awm-widgets.volume-widget.widgets.arc-widget"),
    horizontal_bar = require("awm-widgets.volume-widget.widgets.horizontal-bar-widget"),
    vertical_bar = require("awm-widgets.volume-widget.widgets.vertical-bar-widget")
}
local volume = {}
