...
This widget shows a menu with options to log out from the current session, lock, reboot, suspend and power off the computer, similar to [logout-popup-widget](https://github.com/awesome-wm-widgets/tree/master/logout-popup-widget):
...
```bash
cd ./.config/awesome/
git clone https://github.com/awesome-wm-widgets
```
